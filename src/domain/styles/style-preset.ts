...
export type StylePresetSource = "builtin" | "document" | "user";

export interface StylePresetDeclaration {
  property: string;
  value: string;
  priority: "" | "important";
}
...
export const STYLE_PRESET_PROPERTIES: Record<
  StylePresetTarget,
  readonly string[]
> = {
  text: [
...
export function declarationsForPreset(
  ...
  return STYLE_PRESET_PROPERTIES[target].flatMap((property) => {
